...
export default function FailedLambdaTableSlide() {
  const [failures] = useState<FailedLambda[]>(() => generateMockFailedLambdas());
          ...
          <TableBody>
            {sortedFailures.map((failure) => (
              <TableRow key={failure.id}>
                <TableCell className="font-medium">{failure.functionName}</TableCell>
                <TableCell>
                ...
                <TableCell className="hidden md:table-cell">{failure.region}</TableCell>
                <TableCell className="hidden md:table-cell text-right">
                  {formatDuration(failure.duration)}
                </TableCell>
                <TableCell className="text-right">{failure.retryCount}</TableCell>
                <TableCell>
                  <DropdownMenu>
